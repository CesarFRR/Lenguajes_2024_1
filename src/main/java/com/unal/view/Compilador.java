...
import com.unal.model.parser.ParserAnalyzer;
import com.unal.model.parser.Parser;
import com.unal.model.scanner.Lexer;
import com.unal.model.scanner.LexerAnalyzer;
import com.unal.model.scanner.Token.Token;
import com.unal.utils.TokenTableModel;
...
import com.unal.model.scanner.Token.ColorType;
import com.unal.utils.utils;
import com.unal.utils.Console;
...
//        setVisible(true);
    ...
    private void initComponents() {
        ...
        btnSintactico = new JButton();
        btnSemantico = new JButton();
        ...
        buttonsFilePanelLayout.setHorizontalGroup(
            ...
            .addGroup(GroupLayout.Alignment.TRAILING, buttonsFilePanelLayout.createSequentialGroup()
                .addContainerGap()
                ...
                .addGap(10, 10, 10)
                .addComponent(btnGuardarComo, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jtpCode.setFont(new Font("Monospaced", 0, 14)); // NOI18N
        jtpCode.setForeground(new Color(0, 0, 0));
        jtpCode.setToolTipText("");
        jtpCode.setCaretColor(new Color(0, 0, 0));
        jtpCode.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
        jtpCode.setDisabledTextColor(new Color(0, 0, 153));
        ...
        jtaConsole.setBackground(new Color(255, 255, 255));
        ...
        btnCompilar.setFont(new Font("Roboto", 3, 14)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addComponent(btnLexico, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btnSintactico, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btnSemantico, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        rootPanelLayout.setHorizontalGroup(
            ...
            .addGroup(rootPanelLayout.createSequentialGroup()
                ...
                .addGroup(rootPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(buttonsFilePanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jspCode))
                .addGap(20, 20, 20)
                .addGroup(rootPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane3, GroupLayout.DEFAULT_SIZE, 677, Short.MAX_VALUE)
        ...
        rootPanelLayout.setVerticalGroup(
            ...
            .addGroup(rootPanelLayout.createSequentialGroup()
                ...
                .addGroup(rootPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(rootPanelLayout.createSequentialGroup()
                        .addComponent(jScrollPane3, GroupLayout.PREFERRED_SIZE, 272, GroupLayout.PREFERRED_SIZE)
                        .addGap(20, 20, 20)
    ...
    private void btnGuardarComoActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnGuardarComoActionPerformed
        JFileChooser fileChooser = new JFileChooser();
        fileChooser.setFileFilter(new FileNameExtensionFilter("Text Files", "txt", "cz"));
    ...
    private void btnLexicoActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnLexicoActionPerformed
        this.lexer = null;
        this.parser = null;
    ...
    private void bt_bgActionPerformed(ActionEvent evt) {//GEN-FIRST:event_bt_bgActionPerformed
    ...
    private void btnSintacticoActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnSintacticoActionPerformed
        // TODO add your handling code here:
    ...
    private void btnSemanticoActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnSemanticoActionPerformed
        // TODO add your handling code here:
        this.addTextInConsole("\nAnalisis semántico:\n");
